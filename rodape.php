    ...
    <div class="row panel-footer" style="background-color: rgba(255,255,255,0.8);">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="panel-footer" style="background: none;">
                ...
                <div class="embled-responsive embled-responive-16by9">
            ...
            <form action="rodape_contato-envia.php" method="post" name="form-contato" id="form-contato">
                ...
                <p>
                    <span class="input-group">
                        ...
                        <textarea name="comentarios_contato" id="nome_contato" placeholder="digite o seus comentarios" aria-describedby="basic-addon3" required class="form-control"
                        cols="30" rows="5">
                        </textarea>
                    </span>
                </p>
