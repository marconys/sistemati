...
and r.status_reserva = 'Em análise'";
...
<body class="fundofixo">
    ...
    <main class="container">
        <h1 class="breadcrump alert-warning glyphicon glyphicon-time">Reservas em Análise</h1>
        <table class="table table-condensed table-hover tbopacidade" style="background-color: #ffbc40;">

        <!-- Verifica se existe reservas em analise -->
        <?php if($linha == 0){
                echo "<div><h1 class='breadcrump alert-warning'>Você não possui reservas para análise!</h1></div>";
            }else { ?>
            ...
            <tboby>
                ...
                <?php do { ?>
                    <tr>
                        ...
                        <td>
                            <?php if($linha['status_reserva'] == "Em análise"){
