...
if ($_POST) {
    ...
    if (mysqli_insert_id($conexao)) {
        header('location: reserva_cancelada_lista.php');
    } else {
        header('location: reserva_cancelada_lista.php');
    }
}
...
<head>
    ...
    <title><?php echo SYS_NAME; ?> - Reserva (Retivar)</title>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-offset-2 col-md-8">
                <h2 class="breadcrumb tex-danger">
                    <a href="reserva_cancelada_lista.php">
                        <button class="btn btn-danger">
                            <span class="glyphicon glyphicon-chevron-left"></span>
                        </button>
                    </a>
                    Reativação de Reserva
                </h2>
                <div class="thumbnail">
                    <!-- Abre thumbnail -->
                    <div class="alert alert-success" role="alert">
                        <form action="ativa_reserva.php" method="post" id="form_ativa_reserva" name="form_ativa_reserva" enctype="multipart/form-data">
                            <!-- id_reserva -->
                            ...
                            <br>
                            <!-- Botão Enviar -->
                            <input type="submit" value="Finalizar" name="enviar" id="enviar" class="btn btn-success btn-block">
                        </form>
                    </div>
                </div>
            </div>
