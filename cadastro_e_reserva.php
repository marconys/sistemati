...
<body class="fundofixo">
                    ...
                    <div class="alert alert-info" role="alert">
                        ...
                        <form action="client/reserva_e_cadastro.php" method="post" id="form_reserva_e_cadastro" name="form_reserva_e_cadastro" enctype="multipart/form-data">
                            ...
                            <div class="mostrar">
                                ...
                                <br>
                                <!-- Botão reserva -->
                                <input onclick="mostrarReserva()" type="submit" value="Reserva" name="reserva" id="reserva" class="btn btn-success btn-block">
                            </div> <!-- Fecha cadastro -->
                            <br>
                            <!-- abre reserva -->
                            <div class="esconder">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="numero_pessoas_reserva" value="" name="numero_pessoas_reserva" min="1" step="1" required>
                                </div>
                                <br>
                                ...
                                <br>
                                <!-- Botão Enviar -->
                                <input onclick="mostrarCadastro()" type="submit" value="Cadastrar e Reservar" name="enviar" id="enviar" class="btn btn-success btn-block">
                            </div><!-- fecha reserva -->
                        </form> <!-- fecha form -->
                    </div> <!-- fecha alert -->
                </div><!-- fecha thumnail -->
    ...
    <script src="js/fucoes.js"></script>
</body>
